...
public class SignupActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ButterKnife.bind(this);//똑같이 버터 나이프 예뻐서 쓰는 편입니다.

        //가입 버튼입니다.
        _signupButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                signup();//가입 함수는 밑에 있습니다.
            }
        });
        //로그인으로 넘어가도록 해뒀습니다.
    ...
    public void signup() {
        ...
        //위에까지는 필수 변수 ADDRESS랑 MOBILE은 새로 추가된거입니다.
        //가입 로직을 이 밑에 적어야하는데 바꾸셔도 상관 없습니다.
        //JSONOBJECT가 적혀있는데 시간만 있었으면 이것도 OKHTTP3로 바꿀려고 했습니다.
        if(validate){ return; }
    ...
    //밑에 부턴 구현 하고 싶은 부분을 바꿔 쓰시면 됩니다.
    //최대한 변수 이름을 읽을 수 있게 해뒀으니 어려운건 없을겁니다.
